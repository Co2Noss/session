...
<a href="http://templateace.xyz/nt.php" class="button">Official Note Template</a>
     <a href="http://templateace.xyz/final.php" class="button">Final Incident</a>
     <a href="http://templateace.xyz/mm.php" class="button">Mentor Machine 2.0</a>
