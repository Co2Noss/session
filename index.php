...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	...
	<body><!-- Header --><div align="center" id="login">
			<header id="header">
				<h1>Template Ace 2.0</h1>
			</header><br /><a href="navigator.php" class="button">Login</a><br /><br /><br />
		...
		<!-- Footer -->
			<div align="center" id="footer">
				...
				<ul class="copyright">
                    <li>&copy; 2018 Template Ace</li>
                    <li><a target="_blank" href="https://shell.tni/~charles.yost/beta/privacypolicy.html">Privacy Policy</a></li>
                    <li><a target="_blank" href="https://shell.tni/~charles.yost/beta/terms.html">Terms of Service</a></li>
				</ul>
			</div>
	<!-- Scripts -->
